/* # EMOJI GIMMICK
 *
 * Enables [GitHub-like emojis][GITHUB_EMOJIS].
 *
 * There are upwards of [800 emojis available][CHEAT_SHEET].
 *
 * The emoji are hosted on Heroku with a [Cloudflare CDN][TORTUE_CDN].
 *
 * ## Usage
 *
 *     :smile:
...
(function ($) {
    ...
    function createEmojis() {
        ...
        var cdn = "http://www.tortue.me/emoji/";
        var emojis = [
            /* PEOPLE */
            [/:bowtie:/g, "bowtie"],
            [/:smile:/g, "smile"],
            ...
            [/:disappointed_relieved:/g, "disappointed_relieved"],
            [/:sweat:/g, "sweat"],
            [/:weary:/g, "weary"],
            [/:pensive:/g, "pensive"],
            ...
            [/:trident:/g, "trident"],
            [/:black_small_square:/g, "black_small_square"],
            [/:white_small_square:/g, "white_small_square"],
            [/:black_medium_small_square:/g, "black_medium_small_square"],
            [/:white_medium_small_square:/g, "white_medium_small_square"],
            [/:black_medium_square:/g, "black_medium_square"],
            [/:white_medium_square:/g, "white_medium_square"],
            [/:black_large_square:/g, "black_large_square"],
            [/:white_large_square:/g, "white_large_square"],
        ...
        for (var index in emojis) {
            var emoji = emojis[index][0];
            var title = emojis[index][1];
            var image =
                ...
                cdn +
                title +
                '.png" height="20" width="20" align="absmiddle">';
            html = html.replace(emoji, image);
        }
        content.html(html);
    }
    var emojisGimmick = {
    ...
    $.md.registerGimmick(emojisGimmick);
})(jQuery);
